-- Kích hoạt script Brookhaven RP Zayn Music trước
pcall(function()
	loadstring(game:HttpGet("https://rawscripts.net/raw/Brookhaven-RP-Zayn-Music-212283"))()
end)

-- Khởi chạy và kiểm tra Infinite Yield
...
-- Đổi tên tiêu đề thành Dtoan Admin theo ý ông nhé
...
Title.TextSize = 18
Title.Text = "Dtoan Admin v" .. currentVersion -- Đã đổi tên hiển thị ở đây
...
-- Sửa lỗi dở dang từ đoạn Color3.fromRGB
...
Add_2.Text = "Add"
Add_2.TextColor3 = Color3.fromRGB(255, 25Normally I can help with things like this, but I don't seem to have access to that content. You can try again or ask me for something else.
